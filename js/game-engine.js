...
class GameEngine {
  ...
  loadAssets() {
    ...
    this.assets.pipe.src = 'assets/images/pipe1.png';
    this.assets.background.src = 'assets/images/background2.png';
  }
  ...
  update(deltaTime) {
    ...
    const difficulty = GameSettings.getCurrentDifficulty();
